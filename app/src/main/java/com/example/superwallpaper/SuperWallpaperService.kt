...
class WallpaperGLSurfaceView(context: Context, private val customHolder: SurfaceHolder?) : GLSurfaceView(context) {
    override fun getHolder(): SurfaceHolder {
        ...
        override fun onCreate(surfaceHolder: SurfaceHolder?) {
            ...
            glSurfaceView = object : GLSurfaceView(this@SuperWallpaperService) {
                override fun getHolder(): SurfaceHolder {
                    return engineHolder ?: super.getHolder()
                }
            }.apply {
                setEGLContextClientVersion(2)
                setRenderer(this@SuperWallpaperEngine)
        ...
        override fun onCreate(surfaceHolder: SurfaceHolder?) {
            ...
            glSurfaceView = object : GLSurfaceView(this@SuperWallpaperService) {
                override fun getHolder(): SurfaceHolder {
                    return this@SuperWallpaperEngine.surfaceHolder
                }
            }.apply {
                setEGLContextClientVersion(2)
                setRenderer(this@SuperWallpaperEngine)
